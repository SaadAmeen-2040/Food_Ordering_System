        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-md-6">
                <h3 class="brand-font text-white mb-4 d-flex align-items-center gap-2">
                    <i class="fa-solid fa-utensils text-primary"></i> Foodies
                </h3>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled text-white-50">
                    ...
                    <li class="mb-2"><i class="fa-solid fa-phone me-2 text-primary"></i> +92 300 1234567</li>
                    <li class="mb-2"><i class="fa-solid fa-envelope me-2 text-primary"></i> info@foodies.com</li>
                </ul>
            </div>
